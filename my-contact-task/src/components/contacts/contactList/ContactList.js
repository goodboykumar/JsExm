            ...
            <section className='contact-search p-3'>
                <div className='container'>
                    <div className='grid'>
                        <div className='row'>
                            <div className='col'>
                                <p className='h3'> Contact Manage
                                    <Link to={'/contacts/add'} className="btn btn-primary ms-2" >New <i className='fa fa-plus-circle'></i></Link>
                            ...
                            <div className='card'>
                                <div className='card-body'>
                                    <div className='row align-items-center d-flex justify-content-around'>
                                        ...
                                        <div className='col-md-7'>
                                            <ul className='list-group'>
                                                <li className='list-group-item list-group-item-action'> Name: <span className='fw-bold'>Aniket</span></li>
                                                <li className='list-group-item list-group-item-action'> Mob: <span className='fw-bold'>987455567</span></li>
                                                <li className='list-group-item list-group-item-action'> Email: <span className='fw-bold'>xyz@hotmail.com</span></li>
